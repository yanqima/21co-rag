...
class Settings(BaseSettings):
    ...
    api_port: int = Field(default=8000, env="PORT,API_PORT")
    ...
    embedding_dimension: int = Field(default=1536, env="EMBEDDING_DIMENSION")  # OpenAI text-embedding-3-small dimension
